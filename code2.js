...
gdjs.PruebaCode.GDPausamenuObjects1= [];
gdjs.PruebaCode.GDPausamenuObjects2= [];
gdjs.PruebaCode.GDVoverObjects1= [];
gdjs.PruebaCode.GDVoverObjects2= [];
gdjs.PruebaCode.GDGuardarObjects1= [];
gdjs.PruebaCode.GDGuardarObjects2= [];
gdjs.PruebaCode.GDNewSpriteObjects1= [];
gdjs.PruebaCode.GDNewSpriteObjects2= [];
gdjs.PruebaCode.GDmapaanterioObjects1= [];
gdjs.PruebaCode.GDmapaanterioObjects2= [];
...
gdjs.PruebaCode.GDPausamenuObjects1.length = 0;
gdjs.PruebaCode.GDPausamenuObjects2.length = 0;
gdjs.PruebaCode.GDVoverObjects1.length = 0;
gdjs.PruebaCode.GDVoverObjects2.length = 0;
gdjs.PruebaCode.GDGuardarObjects1.length = 0;
gdjs.PruebaCode.GDGuardarObjects2.length = 0;
gdjs.PruebaCode.GDNewSpriteObjects1.length = 0;
gdjs.PruebaCode.GDNewSpriteObjects2.length = 0;
gdjs.PruebaCode.GDmapaanterioObjects1.length = 0;
gdjs.PruebaCode.GDmapaanterioObjects2.length = 0;
